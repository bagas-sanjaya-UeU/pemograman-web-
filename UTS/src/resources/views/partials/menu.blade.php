    ...
    <ul class="c-sidebar-nav">
        ...
        <li class="c-sidebar-nav-dropdown {{ request()->is('admin/books*') ? " c-show" : "" }}">
            ...
            <ul class="c-sidebar-nav-dropdown-items">
                @can('book_access')
                <li class="c-sidebar-nav-item">
                    <a href="{{ route('admin.books.index') }}" class="c-sidebar-nav-link {{ request()->is("
                        admin/books") || request()->is("admin/books/*") ? "c-active" : "" }}">
        ...
        @endcan
        @can('barang_access')
        <li class="c-sidebar-nav-dropdown {{ request()->is('admin/barangs*') ? " c-show" : "" }}">
            <a class="c-sidebar-nav-dropdown-toggle" href="#">
                <i class="fa-fw fas fa-crown c-sidebar-nav-icon">
            ...
            <ul class="c-sidebar-nav-dropdown-items">
                @can('barang_access')
                <li class="c-sidebar-nav-item">
                    <a href="{{ route('admin.barangs.index') }}" class="c-sidebar-nav-link {{ request()->is("
                        admin/barangs") || request()->is("admin/barangs/*") ? "c-active" : "" }}">
                        <i class="fa-fw fas fa-book c-sidebar-nav-icon">
